...
//        self.view.addSubview(myQuestionsView)
        ...
        guard let selectionAnswerUseCase = selectionAnswerUseCase, let deleteQuestionUseCase = deleteQuestionUseCase else {return}
