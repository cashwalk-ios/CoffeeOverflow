...
final class MyQuestionsDataSource: NSObject, UITableViewDataSource {
    ...
    private let cellIdentifier = "MethodCell"
    
    fileprivate var items: [MyQuestionModel] = [MyQuestionModel(name: "1", description: "111"),MyQuestionModel(name: "2", description: "222"),MyQuestionModel(name: "3", description: "333"),MyQuestionModel(name: "4", description: "444"),MyQuestionModel(name: "5", description: "555"),]
    
//    fileprivate var items: [MyQuestionModel] = [MyQuestionModel(name:"Schedule 1",turnOnStatus:MyQuestionModel.SwitchStatus(time:"",Selected:false),turnOFFStatus:MyQuestionModel.SwitchStatus(time:"",Selected:false),schedule:MyQuestionModel.Schedules.only, selectedDate: ["M","T"]),MyQuestionModel(name:"Schedule 2",turnOnStatus:MyQuestionModel.SwitchStatus(time:"",Selected:false),turnOFFStatus:MyQuestionModel.SwitchStatus(time:"",Selected:false),schedule:MyQuestionModel.Schedules.only, selectedDate: ["M","T"]),MyQuestionModel(name:"Schedule 3",turnOnStatus:MyQuestionModel.SwitchStatus(time:"",Selected:false),turnOFFStatus:MyQuestionModel.SwitchStatus(time:"",Selected:false),schedule:MyQuestionModel.Schedules.only, selectedDate: ["M","T"])]
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as! MethodCell
//
...
extension MyQuestionsDataSource {
    subscript(indexPath: IndexPath) -> MyQuestionModel {
